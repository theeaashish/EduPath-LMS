...
export function AdminCourseCard({ data }: iAppProps) {
  ...
  return (
    <Card className="group relative py-0 gap-0 border-2 overflow-hidden">
      {/* absolute dropdown */}
      <div className="absolute top-2 right-2 z-10">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-48">
            ...
            <DropdownMenuItem asChild>
              <Link href={`/courses/${data.id}/slug`}>
      ...
      <CardContent className="p-4">
        <Link
          ...
          className="font-medium text-lg line-clamp-2 hover:underline group-hover:text-primary transition-colors capitalize"
        >
          {data.title}
        </Link>
